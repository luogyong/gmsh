...
interpolate(const MElement& element, const fullVector<double>& xyz) const{
  ...
  // Interpolate & Return //
  return fsVector->interpolate(element, coef, xyz);
}
...
interpolate(const MElement& element, const fullVector<double>& xyz) const{
  ...
  // Interpolate
  fullVector<double> re = fsVector->interpolate(element, reCoef, xyz);
  fullVector<double> im = fsVector->interpolate(element, imCoef, xyz);
