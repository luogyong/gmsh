...
/*L2_im_eps    = -20.;*/
/*thick_L_2     = 300.*nm;*/
/*hh_L_2        = hh_L_1-thick_L_2;*/

/*re_eps_L_3    =   2.;*/
/*L3_im_eps    = -20.;*/
/*thick_L_3     = 750.*nm;*/
/*hh_L_3        = hh_L_2-thick_L_3;*/

/*re_eps_L_4    =   2.;*/
/*L4_im_eps    = -20.;*/
/*thick_L_4     = 300.*nm;*/
/*hh_L_4        = hh_L_3-thick_L_4;*/

/*a_lat    = 350.*nm;*/
/*rm = 0.15;   //deepness = 0.05;*/
/*ro = 0.233; // given as a fraction of a_lat*/
/*period_x = a_lat;*/
/*period_y = a_lat;*/
/*Deph     = 0; //Pi;*/
/*a_latz = 300.*nm;*/
...
Point(1)  = {-period_x/2,-period_y/2, -period_z/2, Out_lc};
Point(2)  = {-period_x/2, period_y/2, -period_z/2, Out_lc};
Point(3)  = { period_x/2, period_y/2, -period_z/2, Out_lc};
Point(4)  = { period_x/2,-period_y/2, -period_z/2, Out_lc};
Point(5)  = {-period_x/2,-period_y/2,  period_z/2, Out_lc};
Point(6)  = {-period_x/2, period_y/2,  period_z/2, Out_lc};
Point(7)  = { period_x/2, period_y/2,  period_z/2, Out_lc};
Point(8)  = { period_x/2,-period_y/2,  period_z/2, Out_lc};

// PML top and bot
Point(9)   = {-period_x/2,-period_y/2, -period_z/2-PML_bot, PML_lc};
Point(10)  = {-period_x/2, period_y/2, -period_z/2-PML_bot, PML_lc};
Point(11)  = { period_x/2, period_y/2, -period_z/2-PML_bot, PML_lc};
Point(12)  = { period_x/2,-period_y/2, -period_z/2-PML_bot, PML_lc};
Point(13)  = {-period_x/2,-period_y/2,  period_z/2+PML_top, PML_lc};
Point(14)  = {-period_x/2, period_y/2,  period_z/2+PML_top, PML_lc};
Point(15)  = { period_x/2, period_y/2,  period_z/2+PML_top, PML_lc};
Point(16)  = { period_x/2,-period_y/2,  period_z/2+PML_top, PML_lc};

// PML along Y
Point(17)  = {-period_x/2,-period_y/2-PML_lat, -period_z/2 , PML_lc};
Point(18)  = {-period_x/2, period_y/2+PML_lat, -period_z/2 , PML_lc};
Point(19)  = { period_x/2, period_y/2+PML_lat, -period_z/2 , PML_lc};
Point(20)  = { period_x/2,-period_y/2-PML_lat, -period_z/2 , PML_lc};
Point(21)  = {-period_x/2,-period_y/2-PML_lat,  period_z/2 , PML_lc};
Point(22)  = {-period_x/2, period_y/2+PML_lat,  period_z/2 , PML_lc};
Point(23)  = { period_x/2, period_y/2+PML_lat,  period_z/2 , PML_lc};
Point(24)  = { period_x/2,-period_y/2-PML_lat,  period_z/2 , PML_lc};

// PML along X
Point(25)  = {-period_x/2-PML_lat,-period_y/2, -period_z/2 , PML_lc};
Point(26)  = {-period_x/2-PML_lat, period_y/2, -period_z/2 , PML_lc};
Point(27)  = { period_x/2+PML_lat, period_y/2, -period_z/2 , PML_lc};
Point(28)  = { period_x/2+PML_lat,-period_y/2, -period_z/2 , PML_lc};
Point(29)  = {-period_x/2-PML_lat,-period_y/2,  period_z/2 , PML_lc};
Point(30)  = {-period_x/2-PML_lat, period_y/2,  period_z/2 , PML_lc};
Point(31)  = { period_x/2+PML_lat, period_y/2,  period_z/2 , PML_lc};
Point(32)  = { period_x/2+PML_lat,-period_y/2,  period_z/2 , PML_lc};

// 8 missing points
Point(33)  = {-period_x/2-PML_lat,-period_y/2-PML_lat, -period_z/2-PML_bot, PML_lc};
Point(34)  = {-period_x/2-PML_lat, period_y/2+PML_lat, -period_z/2-PML_bot, PML_lc};
Point(35)  = { period_x/2+PML_lat, period_y/2+PML_lat, -period_z/2-PML_bot, PML_lc};
Point(36)  = { period_x/2+PML_lat,-period_y/2-PML_lat, -period_z/2-PML_bot, PML_lc};
Point(37)  = {-period_x/2-PML_lat,-period_y/2-PML_lat,  period_z/2+PML_top, PML_lc};
Point(38)  = {-period_x/2-PML_lat, period_y/2+PML_lat,  period_z/2+PML_top, PML_lc};
Point(39)  = { period_x/2+PML_lat, period_y/2+PML_lat,  period_z/2+PML_top, PML_lc};
Point(40)  = { period_x/2+PML_lat,-period_y/2-PML_lat,  period_z/2+PML_top, PML_lc};


Point(41)  = {-period_x/2,-period_y/2-PML_lat, -period_z/2-PML_bot, PML_lc};
Point(42)  = {-period_x/2, period_y/2+PML_lat, -period_z/2-PML_bot, PML_lc};
Point(43)  = { period_x/2,-period_y/2-PML_lat, -period_z/2-PML_top, PML_lc};
Point(44)  = { period_x/2, period_y/2+PML_lat, -period_z/2-PML_top, PML_lc};
Point(45)  = {-period_x/2,-period_y/2-PML_lat,  period_z/2+PML_bot, PML_lc};
Point(46)  = {-period_x/2, period_y/2+PML_lat,  period_z/2+PML_bot, PML_lc};
Point(47)  = { period_x/2,-period_y/2-PML_lat,  period_z/2+PML_top, PML_lc};
Point(48)  = { period_x/2, period_y/2+PML_lat,  period_z/2+PML_top, PML_lc};


Point(49)  = {-period_x/2-PML_lat, -period_y/2, -period_z/2-PML_bot, PML_lc};
Point(50)  = { period_x/2+PML_lat, -period_y/2, -period_z/2-PML_bot, PML_lc};
Point(51)  = {-period_x/2-PML_lat, -period_y/2,  period_z/2+PML_bot, PML_lc};
Point(52)  = { period_x/2+PML_lat, -period_y/2,  period_z/2+PML_bot, PML_lc};
Point(53)  = {-period_x/2-PML_lat,  period_y/2, -period_z/2-PML_bot, PML_lc};
Point(54)  = { period_x/2+PML_lat,  period_y/2, -period_z/2-PML_bot, PML_lc};
Point(55)  = {-period_x/2-PML_lat,  period_y/2,  period_z/2+PML_bot, PML_lc};
Point(56)  = { period_x/2+PML_lat,  period_y/2,  period_z/2+PML_bot, PML_lc};

Point(57)  = {-period_x/2-PML_lat, -period_y/2-PML_lat, -period_z/2, PML_lc};
Point(58)  = { period_x/2+PML_lat, -period_y/2-PML_lat, -period_z/2, PML_lc};
Point(59)  = {-period_x/2-PML_lat,  period_y/2+PML_lat, -period_z/2, PML_lc};
Point(60)  = { period_x/2+PML_lat,  period_y/2+PML_lat, -period_z/2, PML_lc};
Point(61)  = {-period_x/2-PML_lat, -period_y/2-PML_lat,  period_z/2, PML_lc};
Point(62)  = { period_x/2+PML_lat, -period_y/2-PML_lat,  period_z/2, PML_lc};
Point(63)  = {-period_x/2-PML_lat,  period_y/2+PML_lat,  period_z/2, PML_lc};
Point(64)  = { period_x/2+PML_lat,  period_y/2+PML_lat,  period_z/2, PML_lc};
