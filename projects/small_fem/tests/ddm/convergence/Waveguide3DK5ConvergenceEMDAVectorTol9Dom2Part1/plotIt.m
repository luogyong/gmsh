...
f1 = dlmread('vector_emda_1_1.hist');
f2 = dlmread('vector_emda_2_2.hist');
f3 = dlmread('vector_emda_3_3.hist');
f4 = dlmread('vector_emda_4_4.hist');

m41 = dlmread('vector_emda_4_1.hist');
m42 = dlmread('vector_emda_4_2.hist');
m43 = dlmread('vector_emda_4_3.hist');

%m41 = dlmread('vector_emda_2_1.hist');
