...
i = PmlN - 1;
DdmPml~{0}~{1}[i + 0 * PmlN] = 0; // Remove Left
DdmPml~{0}~{0}[i + 1 * PmlN] = 0; // Remove Right
...
i = PmlN - 1;
// Down
DdmPml~{1}~{1}[i + 0 * PmlN] = 0; // Remove Left
DdmPml~{1}~{0}[i + 1 * PmlN] = 0; // Remove Right
// Up
DdmPml~{2}~{1}[i + 0 * PmlN] = 0; // Remove Left
DdmPml~{2}~{0}[i + 1 * PmlN] = 0; // Remove Right
...
i = PmlN - 1;
// Rear
DdmPml~{3}~{1}[i + 0 * PmlN] = 0; // Remove Left
DdmPml~{3}~{0}[i + 1 * PmlN] = 0; // Remove Right
// Front
DdmPml~{4}~{1}[i + 0 * PmlN] = 0; // Remove Left
DdmPml~{4}~{0}[i + 1 * PmlN] = 0; // Remove Right
...
i = PmlN - 1;
// Rear Down
DdmPml~{5}~{1}[i + 0 * PmlN] = 0; // Remove Left
DdmPml~{5}~{0}[i + 1 * PmlN] = 0; // Remove Right
// Rear Up
DdmPml~{6}~{1}[i + 0 * PmlN] = 0; // Remove Left
DdmPml~{6}~{0}[i + 1 * PmlN] = 0; // Remove Right
// Front Down
DdmPml~{7}~{1}[i + 0 * PmlN] = 0; // Remove Left
DdmPml~{7}~{0}[i + 1 * PmlN] = 0; // Remove Right
// Front Up
DdmPml~{8}~{1}[i + 0 * PmlN] = 0; // Remove Left
DdmPml~{8}~{0}[i + 1 * PmlN] = 0; // Remove Right
